...
var MiniMapNode = function (_a) {
    ...
    return (React__default['default'].createElement("rect", { className: cc(['react-flow__minimap-node', className]), x: x, y: y, rx: borderRadius, ry: borderRadius, width: width, height: height, fill: fill, stroke: strokeColor, strokeWidth: strokeWidth }));
};
...
var MiniMap = function (_a) {
    ...
    var _h = useStoreState(function (s) { return s.transform; }), tX = _h[0], tY = _h[1], tScale = _h[2];
